...
<button type="submit">Continuez avec Facebook</button><br><br>
 <div class="line"> 
...
<label for="connexion">J'ai déjà un compte</label>   <label style="padding-left: 100px;"></label> <input type="submit" name="connexion">Se Connecter 🠒
